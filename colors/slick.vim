...
let colorgroup['CursorLine']   = {"GUIBG":  _lightblack}
let colorgroup['CursorColumn']   = {"GUIBG":  _lightblack}
...
let colorgroup['StatusLine']   = {"GUIFG": _turquoise,      "GUIBG":  _black}
...
let colorgroup['NonText']    = {"GUIFG": _semiblack,      "GUIBG":  _black}
